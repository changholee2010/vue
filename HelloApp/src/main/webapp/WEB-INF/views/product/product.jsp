...
//            console.log(reply[prop]);
    ...
    function makeEditRow2(data) {
        ...
        str += "<td><button onclick='updateReply()'>저장</button></td>"; // <td>10</td><td>user03</td><td><input value=""></td><td><button>저장</button</td>
