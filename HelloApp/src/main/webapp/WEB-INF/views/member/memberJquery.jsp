...
<head>
  ...
  <script>
    ...
    $(document).ready(function () {
      ...
      // 목록 출력 ajax.
      $.ajax({
        url: "jquery/data.json", // 클라이언트가 HTTP 요청을 보낼 서버의 URL 주소
        data: {
          name: "홍길동", // requet.getParameter('name');
          id: 'user01' // requet.getParameter('id');
      ...
      $('#addBtn').on('click', function (e) {
        ...
        // ajax호출.
        $.ajax({
          url: ".do", // 클라이언트가 HTTP 요청을 보낼 서버의 URL 주소
          data: {
            id: '',
            name: "홍길동",
            addr: '',
